...
export default class CustomerService implements ICustomerService {
    ...
    async increaseCustomerBalance(id: string, amount: number): Promise<CustomResponse<ICustomer>> {
        try {
    ...
    async decreaseCustomerBalance(id: string, amount: number): Promise<CustomResponse<ICustomer>> {
        try {
